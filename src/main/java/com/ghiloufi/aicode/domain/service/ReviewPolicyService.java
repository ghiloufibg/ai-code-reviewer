 ...
 *
 * <p>Contains logic for determining review outcomes based on configured policies and quality
 * thresholds.
 */
@DomainService
public class ReviewPolicyService {
  ...
  public boolean requiresHumanApproval(ReviewResult result, CodeReview review) {
    ...
    if (review.getDiffAnalysis() != null && review.getDiffAnalysis().getTotalLineCount() > 500) {
      return true;
    }
