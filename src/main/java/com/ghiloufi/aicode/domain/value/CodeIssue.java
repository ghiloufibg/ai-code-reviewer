 ...
 *
 * <p>Immutable object containing all details about a specific issue including location, severity,
 * and suggested fixes.
 */
public record CodeIssue(
  ...
  public String getDisplayText() {
    String line = isSingleLine() ? "line " + startLine : "lines " + startLine + "-" + endLine;
    return String.format("[%s] %s at %s (%s)", severity.name(), title, line, file);
  }
