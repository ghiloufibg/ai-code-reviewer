 ...
 *
 * <p>Contains the repository identifier and the specific
 * commits or PR being reviewed.
 */
public record RepositoryInfo(
     ...
     */
    public static RepositoryInfo forLocalCommits(String repository, String fromCommit, String toCommit, String baseBranch) {
