 ...
 *
 * <p>A diff hunk contains the line numbers and the actual content of the changes within that range.
 */
public class DiffHunk {
  ...
  public int getAddedLines() {
    return (int)
        lines.stream().filter(line -> line.startsWith("+") && !line.startsWith("+++")).count();
  }
