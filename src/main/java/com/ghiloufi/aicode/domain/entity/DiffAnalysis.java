 ...
 *
 * <p>This entity encapsulates the diff content and its structured
 * representation, providing domain behavior for diff analysis operations.
 */
public class DiffAnalysis {
    ...
    private int calculateTotalLineCount() {
        return fileModifications.stream()
                .mapToInt(FileModification::getLineCount)
                .sum();
    }
    ...
    public List<String> getModifiedFiles() {
        return fileModifications.stream()
                .map(FileModification::getFilePath)
                .toList();
    }
    ...
    public List<FileModification> getFileModifications() { return fileModifications; }
