 ...
 *
 * <p>This entity encapsulates the entire lifecycle of a code review, from initiation through
 * completion, including all analysis results and publication status.
 *
 * <p>Following DDD principles, this entity contains both data and behavior relevant to the code
 * review domain.
 */
public class CodeReview {
  ...
  public ReviewConfiguration getConfiguration() {
  ...
  public DiffAnalysis getDiffAnalysis() {
    return diffAnalysis;
  }
