 ...
 *
 * <p>This entity contains the analysis type, summary, and all issues found during that specific
 * analysis phase.
 */
public class AnalysisResult {
  ...
  public long getCriticalIssueCount() {
    return issues.stream().filter(issue -> issue.severity() == CodeIssue.Severity.ERROR).count();
  }
  ...
  public boolean equals(Object o) {
    ...
    return type == that.type && Objects.equals(analyzedAt, that.analyzedAt);
  }
