 ...
 *
 * <p>Contains the file path and all diff hunks that show the specific changes made to that file.
 */
public class FileModification {
  ...
  public FileModification(
      String filePath, String oldPath, List<DiffHunk> diffHunks, ModificationType type) {
  ...
  public int getLineCount() {
    return diffHunks.stream().mapToInt(DiffHunk::getLineCount).sum();
  }
  ...
  public int getAddedLines() {
    return diffHunks.stream().mapToInt(DiffHunk::getAddedLines).sum();
  }

  /** Gets the number of removed lines. */
  public int getRemovedLines() {
    return diffHunks.stream().mapToInt(DiffHunk::getRemovedLines).sum();
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(filePath, that.filePath) && Objects.equals(oldPath, that.oldPath);
  }
