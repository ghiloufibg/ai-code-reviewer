 ...
 *
 * <p>This entity aggregates all analysis results into a final comprehensive review with merged
 * issues and an overall summary.
 */
public class ReviewResult {
  ...
  public ReviewResult(String summary, List<CodeIssue> issues, List<String> nonBlockingNotes) {
    ...
    this.nonBlockingNotes =
        nonBlockingNotes != null ? List.copyOf(nonBlockingNotes) : new ArrayList<>();
  ...
  public boolean hasBlockingIssues() {
    return issues.stream().anyMatch(issue -> issue.severity() == CodeIssue.Severity.ERROR);
  }
  ...
  public List<String> getNonBlockingNotes() {
    return nonBlockingNotes;
  }
