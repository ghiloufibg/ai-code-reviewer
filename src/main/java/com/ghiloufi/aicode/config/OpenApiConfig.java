 ...
 *
 * <p>This configuration customizes the OpenAPI documentation that will be available at
 * /swagger-ui.html and /v3/api-docs endpoints.
 */
@Configuration
    ...
    return new OpenAPI()
            ...
            new Info()
                ...
                .description(
                    """
                            ...
                            """)
                .version("1.0.0")
                .contact(new Contact().name("AI Code Reviewer").email("support@aicodereview.com"))
        ...
        .servers(
            List.of(
                ...
                new Server().url("https://api.aicodereview.com").description("Production server")));
  }
}
