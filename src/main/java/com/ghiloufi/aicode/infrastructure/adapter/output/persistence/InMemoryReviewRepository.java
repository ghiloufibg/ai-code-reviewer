 ...
 *
 * <p>This is a temporary implementation for demonstration. In production, this would be replaced
 * with a proper database adapter (JPA, MongoDB, etc.).
 */
@Repository
@Slf4j
public class InMemoryReviewRepository implements ReviewRepository {
  ...
  public Flux<CodeReview> findByRepository(String repository) {
    return Flux.fromIterable(reviews.values())
        ...
        .doOnNext(
            review -> log.debug("Found review for repository {}: {}", repository, review.getId()));
  }
