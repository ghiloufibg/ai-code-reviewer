 ...
 *
 * <p>This controller provides a basic endpoint to test the new architecture while maintaining
...
public class SimpleReviewController {
  ...
  public Mono<ResponseEntity<Map<String, String>>> startSimpleReview() {
    ...
    return orchestrator
        .executeCodeReview(applicationConfig)
        .then(
            Mono.just(
                ResponseEntity.ok(
                    Map.of(
                  ...
                  ResponseEntity.internalServerError()
                      .body(
                          Map.of(
                              ...
                              "error",
                              "message",
                              "Review failed: " + error.getMessage())));
            });
  }
