 ...
 *
 * <p>Wraps the existing StaticAnalysisRunner to provide analysis
 * results in the domain format.
 */
@Component
...
public class StaticAnalysisAdapter implements StaticAnalysisPort {
        ...
        for (Map.Entry<String, Object> entry : results.entrySet()) {
            ...
            if (result instanceof String content && !content.isEmpty()) {
                ...
                AnalysisResult analysisResult = new AnalysisResult(
                    type, summary, issues, List.of(), getToolVersion(tool)
                );
    ...
    /**
     * Parses tool output to extract issues.
     * This is a simplified implementation - in production you'd have
     * sophisticated parsers for each tool's output format.
     */
