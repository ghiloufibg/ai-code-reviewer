 ...
 *
 * <p>This test demonstrates both approaches for testing streaming LLM responses:
 * 1. Mock streaming (fast, always available)
 * 2. Integration testing approach (when LLM container is available)
 *
    ...
    void demonstrateStreamingCharacteristics() {
        ...
        StepVerifier.create(mockAdapter.simulateStreamingResponse().collectList())
            .assertNext(chunks -> {
                ...
                log.info("   • Average chunk size: {} chars",
