 ...
 *
 * <p>Configures WebClient and LLM adapters for integration tests with proper timeouts and streaming
 * support.
 */
@TestConfiguration
...
public class LlmIntegrationTestConfig {
  ...
  public OllamaLlmStreamingAdapter ollamaLlmStreamingAdapter(
      WebClient llmWebClient, String ollamaBaseUrl, String ollamaModelName) {
