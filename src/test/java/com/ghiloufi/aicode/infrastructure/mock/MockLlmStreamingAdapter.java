 ...
 *
 * <p>This adapter provides predictable streaming behavior for unit tests and CI/CD environments
 * where running actual LLM containers isn't feasible.
 *
 * <p>Use this in environments where resources are limited or when you need deterministic test
 * behavior.
 */
@TestComponent
@Profile("mock-test")
...
public class MockLlmStreamingAdapter implements LlmAnalysisPort, AIAnalysisPort {
  ...
  private static final List<String> SIMULATED_STREAMING_CHUNKS =
      List.of(
          "## Code Review Summary\\n\\n",
