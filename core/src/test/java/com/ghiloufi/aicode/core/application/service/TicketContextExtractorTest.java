...
final class TicketContextExtractorTest {
  ...
  void should_extract_bracketed_ticket_id_from_title() {
    ...
    final TicketContextExtractor extractor = new TicketContextExtractor(ticketSystem);

    final Mono<TicketBusinessContext> result =
        extractor.extractFromMergeRequest("[TM-123] : Fix authentication", null);
  ...
  void should_extract_bracketed_ticket_id_from_description_when_not_in_title() {
    ...
    final Mono<TicketBusinessContext> result =
        extractor.extractFromMergeRequest(
  ...
  void should_prioritize_title_over_description() {
    ...
    final Mono<TicketBusinessContext> result =
        extractor.extractFromMergeRequest("[TM-123] : Fix", "Related to [TM-999]");
  ...
  void should_return_empty_when_no_ticket_id_found() {
    ...
    final Mono<TicketBusinessContext> result =
        extractor.extractFromMergeRequest("Fix authentication", "No ticket reference");
  ...
  void should_return_empty_when_title_and_description_are_null() {
    ...
    final Mono<TicketBusinessContext> result = extractor.extractFromMergeRequest(null, null);
  ...
  void should_return_empty_when_title_and_description_are_blank() {
    ...
    final Mono<TicketBusinessContext> result = extractor.extractFromMergeRequest("   ", "  ");
  ...
  void should_match_various_bracketed_formats() {
    ...
    final Mono<TicketBusinessContext> result1 =
        extractor.extractFromMergeRequest("[PROJ-456] : Feature implementation", null);
    final Mono<TicketBusinessContext> result2 =
        extractor.extractFromMergeRequest("[ABC-1]: Quick fix", null);
    final Mono<TicketBusinessContext> result3 =
        extractor.extractFromMergeRequest("[LONGNAME-9999] Update API", null);
  ...
  void should_extract_first_bracketed_ticket_when_multiple_present() {
    ...
    final Mono<TicketBusinessContext> result =
        extractor.extractFromMergeRequest("[TM-123] : Related to [TM-456]", null);
