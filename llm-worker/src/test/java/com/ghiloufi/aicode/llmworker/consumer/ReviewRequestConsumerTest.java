...
@DisplayName("ReviewRequestConsumer Tests")
final class ReviewRequestConsumerTest {

  @Nested
  @DisplayName("Worker Properties Configuration")
  final class WorkerPropertiesConfiguration {
    ...
    void should_return_consumer_group_when_provided() {
      final WorkerProperties props =
          new WorkerProperties("my-group", "worker-1", "my-stream", 10, 60);
    ...
    void should_return_null_consumer_group_when_null_provided() {
      final WorkerProperties props = new WorkerProperties(null, "worker-1", null, 0, 0);
    ...
    void should_return_null_stream_key_when_null_provided() {
      final WorkerProperties props = new WorkerProperties("group", "worker", null, 10, 60);

      assertThat(props.getStreamKey()).isNull();
    }

    @Test
    @DisplayName("should_use_batch_size")
    void should_use_batch_size() {
    ...
    @Test
    @DisplayName("should_use_timeout_seconds")
    void should_use_timeout_seconds() {
  ...
  final class ConfigurationEdgeCases {
